...
if (!hasRole($USER['role'] ?? '', 'receptionist')) {
    die("Access denied!");
}
?>
...
<body class="role-receptionist">
    ...
    <div class="main-content">
        ...
        <?php $pageTitle = "Receptionist Dashboard"; include '../components/navbar.php'; ?>
    ...
    <!-- Profile & Confirmation Modals (Shared Components) -->
    ...
    <script>
        /**
         * Override showSection for receptionist-specific logic
         */
                    ...
                    contentArea.innerHTML = `
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-muted mt-3">Welcome to your Receptionist Dashboard</p>
                            </div>
                        </div>
                    `;
                    break;
