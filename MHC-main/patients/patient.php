...
<body>
    ...
    <div class="patient-page-wrapper">
        ...
        <header class="patient-header">
            <div>
                <h2 class="patient-name mb-1"><?= h($patient['name']) ?></h2>
                <div class="patient-id-text">Patient ID: PAT<?= (int)$patient['id'] ?></div>
            </div>
            ...
            <ul class="nav nav-tabs border-0" id="patientTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="case_update-tab" data-bs-toggle="tab"
                        ...
                        <span class="tab-icon">📝</span> case update
                    </button>
                </li>
        ...
        <div class="tab-content patient-tab-content" id="patientTabContent">
            ...
            <div class="tab-pane fade" id="case" role="tabpanel" aria-labelledby="case_-tab">
                <iframe
                    ...
                    src="case.php?patient_id=<?= (int)$patient['id'] ?>"></iframe>
            </div>

            <!-- PRESCRIPTIONS TAB – full width iframe -->
            <div class="tab-pane fade" id="prescriptions" role="tabpanel" aria-labelledby="prescriptions-tab">
                <iframe src="prescriptions.php?patient_id=<?= (int)$patient['id'] ?><?php if ($latest_case_id > 0) echo '&case_id=' . (int)$latest_case_id; ?>" class="inner-tab-frame"></iframe>
            </div>
            ...
            <div class="tab-pane fade" id="case_update" role="tabpanel" aria-labelledby="case_update-tab">
                <?php if ($latest_case_id > 0): ?>
                    <iframe class="inner-tab-frame" src="case_update.php?case_id=<?= (int)$latest_case_id ?>"></iframe>
                <?php else: ?>
                    <div style="padding:20px; background:#fff; border-radius:8px;">
                        <p><strong>No case found for this patient yet.</strong></p>
                        <p>Create a case first (from "case details") or <a href="create_case.php?patient_id=<?= (int)$patient['id'] ?>">click here to add one</a>.</p>
                    </div>
                <?php endif; ?>
            </div>
